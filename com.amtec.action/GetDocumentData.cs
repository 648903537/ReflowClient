    ...
    public class GetDocumentData
    {
        ...
        public List<DocumentEntity> GetDocumentDataByStation()
        {
            ...
            if (errorCode != 0)
            {
                ...
                view.errorHandler(2, init.lang.ERROR_API_CALL_ERROR + " mdaGetDocuments " + errorCode + "(" + errorString + ")", "");
                return null;
            }
            else
            {
        ...
        public byte[] GetDocumnetContentByID(long documentID)
        {
            ...
            if (error != 0)
            {
                ...
                view.errorHandler(2, init.lang.ERROR_API_CALL_ERROR + " mdaGetDocumentContent " + error + "(" + errorString + ")", "");
                return null;
            }
            else
            {
        ...
        public Advice[] GetAdviceByStationAndWO(string workorder)
        {
            ...
            {
                string errorString = UtilityFunction.GetZHSErrorString(error, init, sessionContext);
                view.errorHandler(2, init.lang.ERROR_API_CALL_ERROR + " adviceGetAdvice " + error + "(" + errorString + ")", "");
            }
            else
            {
