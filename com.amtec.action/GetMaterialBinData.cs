...
namespace com.amtec.action
{
    public class GetMaterialBinData
    {
        ...
        public string[] GetMaterialBinDataDetails(string materialBinNo)
        {
            ...
            string[] materialBinResultKeys = new string[] { "MATERIAL_BIN_NUMBER", "MATERIAL_BIN_PART_NUMBER", "MATERIAL_BIN_QTY_ACTUAL", "MATERIAL_BIN_QTY_TOTAL", "PART_DESC", "MSL_FLOOR_LIFETIME_REMAIN", "EXPIRATION_DATE" };
